...
public class AkUnityIntegrationBuilderBase
{
	...
	public AkUnityIntegrationBuilderBase()
	{
		...
		m_assetsPluginsDir = System.IO.Path.Combine(m_assetsDir, "ThirdParty", "Plugins");
		m_buildScriptDir =
			System.IO.Path.Combine(System.IO.Path.Combine(System.IO.Path.Combine(m_assetsDir, "ThirdParty", "Wwise"), "AkUnitySoundEngine"),
				"Common");

...
public static class AkWwiseProjectInfo
{
	...
	private static string s_wwiseEditorDirectory = System.IO.Path.Combine("ThirdParty", "Wwise", "Editor").Replace('\\','/');
	...
	{
#if PROJECT_FIXES
		return System.IO.Directory.Exists(System.IO.Path.Combine(UnityEngine.Application.dataPath, "ThirdParty", "Wwise"));
#else

...
#if PROJECT_FIXES
				var akInitializer = objWwise.AddComponent<AkInitializer>();
                UnityEditor.Undo.RegisterCreatedObjectUndo(objWwise, "Created missing Wwise Global");
#else

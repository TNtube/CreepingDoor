...
#endif
{
	...
	{
        // TODO : Les lignes suivantes font crash :
		...
		if (AkWwiseEditorSettings.Instance.CopySoundBanksAsPreBuildStep)
		{
			...
			{
                if (destinationSoundBankFolder == "Successfull") destinationSoundBankFolder = string.Empty;
                else UnityEngine.Debug.LogErrorFormat("WwiseUnity: SoundBank folder has not been copied for <{0}> target at <{1}>. This will likely result in a build without sound!!!", target, path);
			}
		}
#endif

...
namespace Kamgam.ExcludeFromBuild
{
    ...
    {
#if PROJECT_FIXES
        public const string DataFilePath = "Assets/ThirdParty/Plugins/ExcludeFromBuild/ExcludeFromBuildData.asset";
#else
        public const string DataFilePath = "Assets/Plugins/ExcludeFromBuild/ExcludeFromBuildData.asset";
#endif

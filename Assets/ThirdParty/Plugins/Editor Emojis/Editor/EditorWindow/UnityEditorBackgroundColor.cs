...
namespace Anvil.EditorEmojis
{
    public static class UnityEditorBackgroundColor
    {
        ...
        public static Color Get(HierarchyObjectState hierarchyObjectStatus, bool isWindowFocused, int selectedAmount = 0)
        {
            return (Color)GetSystemColor(hierarchyObjectStatus, isWindowFocused, selectedAmount);
        }

        
        private static SystemColor GetSystemColor(HierarchyObjectState obj, bool isWindowFocused, int selectedObjectsAmount = 0)
        {
    ...
    public struct HierarchyObjectState
    {

    ...
    {       
            ...
            List<MagicLightProbes> allGroups)
        {
            ...
            if (allGroups.Count == 0 || listChanged)
            {
                ...
                {
                    tempVolumeList.AddRange(Object.FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None));
            ...
            switch (selectedTab)
            {
                ...
                case 1:
                    ...
                    if (GUILayout.Button("Calculate All Volumes"))
                    {
                        ...
                        Selection.activeObject = GameObject.FindFirstObjectByType<MLPCombinedVolume>();
        ...
        public static void MLPCombinedVolumeEditor (MLPCombinedVolume target)
        {
            ...
            volumes.AddRange(Object.FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None));

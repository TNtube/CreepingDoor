...
namespace MagicLightProbes
{
    public class MLPManager : EditorWindow
    {
        ...
        static void Init()
        {
            ...
            probeGroups.Clear();
            probeGroups.AddRange(FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None));
        ...
        {            
            ...
            {
                lights = FindObjectsByType<Light>(FindObjectsSortMode.None);
                List<MLPLight> tempList = new List<MLPLight>(FindObjectsByType<MLPLight>(FindObjectsSortMode.None));
            ...
            volumesCount = FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None).Length;
        ...
        private void FindStaticObjects()
        {
            ...
            UnityEngine.GameObject[] All_GOs = FindObjectsByType<GameObject>(FindObjectsSortMode.None);

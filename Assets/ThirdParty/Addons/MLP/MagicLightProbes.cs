...
#pragma warning restore CS0414
        ...
        {
            allVolumes = new List<MagicLightProbes>(FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None));
        ...
        public IEnumerator DebugCalculateProbesVolume()
        {
            ...
            MagicLightProbes[] volumes = FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None);
        ...
        public IEnumerator CalculateProbesVolume()
        {
            ...
            {
                volumes.AddRange(FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None));
            }
        ...
        {
            UnityEngine.Object[] All_GOs = FindObjectsByType<GameObject>(FindObjectsSortMode.None);
        ...
        private IEnumerator PrepareScene()
        {
            ...
            if (workflow == Workflow.Advanced)
            {
                ...
                checkList.AddRange(FindObjectsByType<MLPLight>(FindObjectsSortMode.None));
            ...
            {
                All_GOs = FindObjectsByType<GameObject>(FindObjectsSortMode.None);
            }    

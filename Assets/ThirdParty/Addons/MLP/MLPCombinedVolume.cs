...
namespace MagicLightProbes
{
    ...
    public class MLPCombinedVolume : MonoBehaviour
    {
        ...
        {            
            ...
            volumes = FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None);
        ...
        {
            MagicLightProbes[] mlpVolumes = FindObjectsByType<MagicLightProbes>(FindObjectsSortMode.None);
